...
/**
 * Test to iterate a list of SOL addresses and sent a fraction of a penny to. This illustrates the
 * ability to Airdrop a given token directly to SOl addresses.
 */
