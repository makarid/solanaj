package org.makarid.solanaj.core;
...
import org.makarid.solanaj.rpc.Cluster;
...
import org.makarid.solanaj.rpc.types.TokenResultObjects.*;
import org.makarid.solanaj.rpc.types.config.Commitment;
import org.makarid.solanaj.token.TokenManager;
...
public class MainnetTest extends AccountBasedTest {
  ...
  private static final PublicKey USDC_TOKEN_MINT =
  ...
  public void getAccountInfoBase64() throws RpcException {
    ...
    final AccountInfo accountInfo =
        client
            .getApi()
            .getAccountInfo(PublicKey.valueOf("So11111111111111111111111111111111111111112"));
    ...
    try {
      ...
      final AccountInfo accountInfo =
          client
              ...
              .getAccountInfo(
                  PublicKey.valueOf("So11111111111111111111111111111111111111112"),
                  Map.of("commitment", Commitment.ROOT));
      final double balance = (double) accountInfo.getValue().getLamports() / LAMPORTS_PER_SOL;
  ...
  public void getAccountInfoJsonParsed() {
    try {
      final SplTokenAccountInfo accountInfo =
          client
              .getApi()
              .getSplTokenAccountInfo(
                  PublicKey.valueOf("8tnpAECxAT9nHBqR1Ba494Ar5dQMPGhL31MmPJz1zZvY"));

      assertTrue(accountInfo.getValue().getData().getProgram().equalsIgnoreCase("spl-token"));
  ...
  public void transactionMemoTest() {
    ...
    transaction.addInstruction(
        SystemProgram.transfer(feePayer.getPublicKey(), destination, lamports));
  ...
  public void getBlockCommitmentTest() {
    ...
    try {
      ...
      LOGGER.info(
          String.format("block = %d, totalStake = %d", block, blockCommitment.getTotalStake()));
  ...
  public void getVersionTest() throws RpcException {
    ...
    LOGGER.info(
        String.format(
            "solana-core: %s, feature-set: %s", version.getSolanaCore(), version.getFeatureSet()));
  ...
  public void getInflationRateTest() throws RpcException {
    ...
    assertEquals(
        inflationRate.getTotal(),
        inflationRate.getFoundation() + inflationRate.getValidator(),
        0.0);
  }
  ...
  public void getInflationRewardTest() throws RpcException {
    List<InflationReward> inflationRewards =
        client
            .getApi()
            .getInflationReward(
                Arrays.asList(
  ...
  public void getSlotLeadersTest() throws RpcException {
    ...
    slotLeaders.forEach(slotLeader -> LOGGER.info(slotLeader.toString()));
  ...
  public void getSupplyTest() throws RpcException {
    ...
    assertEquals(
        supply.getValue().getTotal(),
        supply.getValue().getCirculating() + supply.getValue().getNonCirculating());
  ...
  public void getTokenAccountBalanceTest() throws RpcException {
    TokenAmountInfo tokenAccountBalance =
        client
            .getApi()
  ...
  public void getTokenSupplyTest() throws RpcException {
    TokenAmountInfo tokenSupply =
        client
            .getApi()
            .getTokenSupply(PublicKey.valueOf("4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R"));
    ...
    List<TokenAccount> tokenAccounts =
        client
            ...
            .getTokenLargestAccounts(
                PublicKey.valueOf("4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R"));
  ...
  public void getTokenAccountsByOwnerTest() throws RpcException {
    ...
    TokenAccountInfo tokenAccount =
        client
            ...
            .getTokenAccountsByOwner(
                PublicKey.valueOf("AoUnMozL1ZF4TYyVJkoxQWfjgKKtu8QUK9L4wFdEJick"),
                requiredParams,
                new HashMap<>());
    ...
    assertEquals(
        "27T5c11dNMXjcRuko9CeUy3Wq41nFdH3tz9Qt4REzZMM", tokenAccount.getValue().get(0).getPubkey());
  }
  ...
  public void getFeeCalculatorForBlockhashTest() throws RpcException, InterruptedException {
    ...
    Thread.sleep(20000L);
    FeeCalculatorInfo feeCalculatorInfo =
        client.getApi().getFeeCalculatorForBlockhash(recentBlockHash);
  ...
  public void getFeesRateGovernorTest() throws RpcException {
    ...
    assertTrue(
        feeRateGovernorInfo.getValue().getFeeRateGovernor().getMaxLamportsPerSignature() > 0);
    assertTrue(
        feeRateGovernorInfo.getValue().getFeeRateGovernor().getMinLamportsPerSignature() > 0);
    assertTrue(
        feeRateGovernorInfo.getValue().getFeeRateGovernor().getTargetLamportsPerSignature() >= 0);
    assertTrue(
        feeRateGovernorInfo.getValue().getFeeRateGovernor().getTargetSignaturesPerSlot() >= 0);
  }
  ...
  public void getStakeActivationTest() throws RpcException {
    StakeActivation stakeActivation =
        client
            .getApi()
            .getStakeActivation(
                PublicKey.valueOf("H8VT3V6EDiYiQqmeDgqZJf4Tt76Qe6WZjPhighAGPL5T"), 155L, null);
  ...
  public void simulateTransactionTest() throws RpcException {
    ...
    List<PublicKey> addresses =
        List.of(PublicKey.valueOf("QqCCvshxtqMAL2CVALqiJB7uEeE5mjSPsseQdDzsRUo"));
    SimulatedTransaction simulatedTransaction =
        client.getApi().simulateTransaction(transaction, addresses);
  ...
  public void sendTokenTest() {
    ...
    final String txId =
        tokenManager.transfer(owner, source, destination, USDC_TOKEN_MINT, tokenAmount);
    ...
    */
    ...
    final String txId =
        tokenManager.transferCheckedToSolAddress(
            owner, source, destination, USDC_TOKEN_MINT, tokenAmount, decimals);
  ...
  public void initializeAccountTest() {
    ...
    final String txId = tokenManager.initializeAccount(newAccount, USDC_TOKEN_MINT, owner);
  ...
  public void getConfirmedTransactionTest() throws RpcException {
    String txId =
        "46VcVPoecvVASnX9vHEZLA8JMS6BVXhvMMhqtGBcn9eg4bHehK6uA2icuTjwjWLZxwfxdT2z1CqYxCHHvjorvWDi";
  ...
  public void getLeaderScheduleTest_identity() throws RpcException {
    List<LeaderSchedule> leaderSchedules =
        client
            .getApi()
            .getLeaderSchedule(null, "12oRmi8YDbqpkn326MdjwFeZ1bh3t7zVw8Nra2QK2SnR", null);

    assertSame(1, leaderSchedules.size());
    assertEquals(
        "12oRmi8YDbqpkn326MdjwFeZ1bh3t7zVw8Nra2QK2SnR", leaderSchedules.get(0).getIdentity());
  }

  @Test
  public void getMultipleAccountsTest() throws RpcException {
    List<AccountInfo.Value> accounts =
        client
            .getApi()
            .getMultipleAccounts(
                List.of(
