...
public class MainnetTest extends AccountBasedTest {
  ...
  public void getClusterNodesTest() {
    try {
      ...
      clusterNodes.forEach(clusterNode -> LOGGER.info(clusterNode.toString()));
    } catch (RpcException e) {
      e.printStackTrace();
    }
  }
  ...
  public void getTokenLargestAccountsTest() throws RpcException {
    ...
    tokenAccounts.forEach(tokenAccount -> assertEquals(6, tokenAccount.getDecimals()));
  }
  ...
  public void getConfirmedBlocksTest() throws RpcException {
    ...
    assertEquals(Double.valueOf(5), blocks.get(0));
    assertEquals(Double.valueOf(5), singleBlock.get(0));
  }
