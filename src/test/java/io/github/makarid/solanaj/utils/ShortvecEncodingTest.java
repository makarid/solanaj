package io.github.makarid.solanaj.utils;
...
public class ShortvecEncodingTest {
  ...
  public void encodeLength() {
    ...
    assertArrayEquals(
        new byte[] {-128, 1} /* [0x80, 0x01] */, ShortvecEncoding.encodeLength(128)); // 0x80
    assertArrayEquals(
        new byte[] {-1, 1} /* [0xff, 0x01] */, ShortvecEncoding.encodeLength(255)); // 0xff
    assertArrayEquals(
        new byte[] {-128, 2} /* [0x80, 0x02] */, ShortvecEncoding.encodeLength(256)); // 0x100
    assertArrayEquals(
        new byte[] {-1, -1, 1} /* [0xff, 0xff, 0x01] */,
        ShortvecEncoding.encodeLength(32767)); // 0x7fff
    assertArrayEquals(
        new byte[] {-128, -128, -128, 1} /* [0x80, 0x80, 0x80, 0x01] */,
