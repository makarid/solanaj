...
public class AccountNotificationEventListener implements NotificationEventListener {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(AccountNotificationEventListener.class.getName());

  /**
   * Handle Account notification event (change in data or change in lamports). Type of "data" is a
   * Map.
   *
   * @param data Map
   */
