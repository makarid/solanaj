...
public class MangoSpotMarketInfo {
  ...
  public static final int MANGO_SPOT_MARKET_INFO_LAYOUT_SIZE =
      PublicKey.PUBLIC_KEY_LENGTH + (5 * I80F48.I80F48_LENGTH);
  ...
  public static MangoSpotMarketInfo readMangoSpotMarketInfo(byte[] data) {
    final MangoSpotMarketInfo mangoSpotMarketInfo = MangoSpotMarketInfo.builder().build();
