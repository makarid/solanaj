...
public class MangoPerpAccount {
  ...
  private static final int MANGO_GROUP_OFFSET =
  ...
  private static final int DEPOSITS_OFFSET =
      NUM_IN_MARGIN_BASKET_OFFSET + 1; // numInMarginBasket is 1 byte
  ...
  public static MangoPerpAccount readMangoPerpAccount(final PublicKey publicKey, byte[] data) {
    ...
    for (int i = 0; i < MAX_TOKENS; i++) {
      final I80F48 i80F48 = I80F48.readI80F48(data, DEPOSITS_OFFSET + (i * I80F48.I80F48_LENGTH));
    ...
    for (int i = 0; i < MAX_TOKENS; i++) {
      final I80F48 i80F48 = I80F48.readI80F48(data, BORROWS_OFFSET + (i * I80F48.I80F48_LENGTH));
