...
import static org.p2p.solanaj.programs.mango.model.MangoUtils.*;
...
public class MangoGroup {
  ...
  private static final int SPOT_MARKETS_OFFSET =
      INDEXES_OFFSET + (((U64F64.U64F64_LENGTH * 2) + U64_SIZE_BYTES) * NUM_TOKENS);
  ...
  private static final int MINT_DECIMALS_OFFSET =
      BORROW_LIMITS_OFFSET + (U64_SIZE_BYTES * NUM_TOKENS);
