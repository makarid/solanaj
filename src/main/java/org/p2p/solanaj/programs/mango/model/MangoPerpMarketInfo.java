...
public class MangoPerpMarketInfo {
  ...
  public static final int MANGO_PERP_MARKET_INFO_LAYOUT_SIZE =
      PublicKey.PUBLIC_KEY_LENGTH + (5 * I80F48.I80F48_LENGTH) + (2 * MangoUtils.U64_SIZE_BYTES);

  private static final int SPOT_MARKET_OFFSET = 0;
  private static final int MAINT_ASSET_WEIGHT_OFFSET =
      SPOT_MARKET_OFFSET + PublicKey.PUBLIC_KEY_LENGTH;
  private static final int INIT_ASSET_WEIGHT_OFFSET =
      MAINT_ASSET_WEIGHT_OFFSET + I80F48.I80F48_LENGTH;
  private static final int MAINT_LIAB_WEIGHT_OFFSET =
      INIT_ASSET_WEIGHT_OFFSET + I80F48.I80F48_LENGTH;
  private static final int INIT_LIAB_WEIGHT_OFFSET =
      MAINT_LIAB_WEIGHT_OFFSET + I80F48.I80F48_LENGTH;
  ...
  public static MangoPerpMarketInfo readMangoPerpMarketInfo(byte[] data) {
    final MangoPerpMarketInfo mangoPerpMarketInfo = MangoPerpMarketInfo.builder().build();
