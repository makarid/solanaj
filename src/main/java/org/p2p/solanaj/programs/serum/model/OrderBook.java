 ...
 * <p>Note:
 *
 * <p>buffer_layout_1.blob(5), layout_1.accountFlagsLayout('accountFlags'),
 * slab_1.SLAB_LAYOUT.replicate('slab'), buffer_layout_1.blob(7),
 */
public class OrderBook {
   ...
   *
   * @return {@link List} containing {@link Order}s built from existing the {@link OrderBook} {@link
   *     Slab}.
   */
              ...
              if (slabNode instanceof SlabLeafNode) {
                ...
                orders.add(
                    Order.builder()
                        ...
                        .floatQuantity(
                            (float)
                                ((slabLeafNode.getQuantity() * baseLotSize)
                                    / SerumUtils.getBaseSplTokenMultiplier(baseDecimals)))
