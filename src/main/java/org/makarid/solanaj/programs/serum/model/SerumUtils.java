...
import org.makarid.solanaj.rpc.types.ProgramAccount;
 ...
 *
 * <p>blob(5), 0-4 accountFlagsLayout('accountFlags'), 5-12 publicKeyLayout('ownAddress'), 13-44
 * u64('vaultSignerNonce'), 45-52 publicKeyLayout('baseMint'), 53-84 publicKeyLayout('quoteMint'),
 * 85-116 publicKeyLayout('baseVault'), 117-148 u64('baseDepositsTotal'), 149-156
 * u64('baseFeesAccrued'), 157-164 publicKeyLayout('quoteVault'), 165-196
 *
 * <p>u64('quoteDepositsTotal'), 197-204 u64('quoteFeesAccrued'), 205-212
 *
 * <p>u64('quoteDustThreshold'), 213-220
 *
 * <p>private PublicKey requestQueue; 221-252 private PublicKey eventQueue; 253-284
 *
 * <p>private PublicKey bids; 285-316 private PublicKey asks; 317-348
 *
 * <p>private long baseLotSize; 349-356 private long quoteLotSize; 357-364 private long feeRateBps;
 * 365-372 private long referrerRebatesAccrued 373-380;
 *
 * <p>....
 */
...
public class SerumUtils {
  ...
  public static final PublicKey SERUM_PROGRAM_ID_V3 =
      new PublicKey("9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin");
  public static final PublicKey WRAPPED_SOL_MINT =
  ...
  public static void writeSelfTradeBehavior(
      ByteBuffer result, SelfTradeBehaviorLayout selfTradeBehavior) {
   ...
   *
   * <p>Note: MINT_LAYOUT = struct([blob(44), u8('decimals'), blob(37)]);
   *
   * <p>0-43 = other data index 44 = the single byte of decimals we want 45-... = other data
   *
  ...
  public static float priceLotsToNumber(
      long price, byte baseDecimals, byte quoteDecimals, long baseLotSize, long quoteLotSize) {
  ...
  public static long priceNumberToLots(
      float price, byte quoteDecimals, long baseLotSize, byte baseDecimals, long quoteLotSize) {
  ...
  public static OpenOrdersAccount findOpenOrdersAccountForOwner(
      RpcClient client, PublicKey marketAddress, PublicKey ownerAddress) {
    int dataSize = 3228;
    ...
    try {
      programAccounts =
          client.getApi().getProgramAccounts(SERUM_PROGRAM_ID_V3, memcmpList, dataSize);
    ...
    if (programAccounts != null) {
      Optional<ProgramAccount> optionalAccount = programAccounts.stream().findFirst();
  ...
  public static long getLamportsNeededForSolWrapping(
      float price, float size, boolean isBuy, OpenOrdersAccount openOrdersAccount) {
    long lamports;
  ...
  public static PublicKey getVaultSigner(Market market) {
    ...
    final PublicKey vaultSigner =
        PublicKey.createProgramAddress(
            List.of(market.getOwnAddress().toByteArray(), vaultSignerNonce),
