...
import org.makarid.solanaj.utils.bip32.wallet.DerivableType;
import org.makarid.solanaj.utils.bip32.wallet.SolanaBip44;
...
public class Account {
  ...
  public static Account fromMnemonic(List<String> words, String passphrase) {
    ...
    DeterministicKey child =
        deterministicHierarchy.get(HDUtils.parsePath("M/501H/0H/0/0"), true, true);
    TweetNaclFast.Signature.KeyPair keyPair =
        TweetNaclFast.Signature.keyPair_fromSeed(child.getPrivKeyBytes());
    return new Account(keyPair);
  }

  /**
   * Derive a Solana account from a Mnemonic generated by the Solana CLI using bip44 Mnemonic with
   * deviation path of m/55H/501H/0H
   *
  ...
  /**
   * Derive a Solana account from a Mnemonic generated by the Solana CLI using bip44 Mnemonic with
   * deviation path of m/55H/501H/0H/0H
   *
   * @param words seed words
   * @param passphrase seed passphrase
   * @return Solana account
  ...
  /**
   * Convert's a Sollet-exported JSON string into a byte array usable for {@link Account}
   * instantiation
   *
