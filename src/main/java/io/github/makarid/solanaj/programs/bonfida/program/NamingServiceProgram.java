package io.github.makarid.solanaj.programs.bonfida.program;

import io.github.makarid.solanaj.core.*;
...
public class NamingServiceProgram extends Program {
   ...
   *
   * @return {@link TransactionInstruction} object to use in a {@link Transaction}
   */
  public static TransactionInstruction createNameRegistry(
    ...
    return createTransactionInstruction(nameProgramId, keys, instructionData);
  }
}
