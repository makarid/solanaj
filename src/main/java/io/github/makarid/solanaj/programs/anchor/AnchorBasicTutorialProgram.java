package io.github.makarid.solanaj.programs.anchor;
...
public class AnchorBasicTutorialProgram extends Program {
  ...
  // Testnet address of basic-0 = EkEwddr34fqnv2SJREPynyC335PE32PAfjY4LVW5bTJS (has a method called
  // initialize)
  private static final PublicKey PROGRAM_ID =
      new PublicKey("EkEwddr34fqnv2SJREPynyC335PE32PAfjY4LVW5bTJS");
  ...
  private static byte[] encodeInitializeData() {
    ...
    try {
      ...
      encodedHash =
          Arrays.copyOfRange(
              digest.digest(FUNCTION_NAMESPACE.getBytes(StandardCharsets.UTF_8)),
              sigHashStart,
              sigHashEnd);
