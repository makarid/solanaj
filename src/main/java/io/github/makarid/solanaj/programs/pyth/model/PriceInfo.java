...
public class PriceInfo {
  ...
  private static final int CONFIDENCE_COMPONENT_OFFSET =
      PRICE_COMPONENT_OFFSET + PythUtils.INT64_SIZE;
  ...
  public static PriceInfo readPriceInfo(byte[] data, int exponent) {
    ...
    priceInfo.setConfidence(
        ((float) priceInfo.getConfidenceComponent()) * (float) Math.pow(10, exponent));
