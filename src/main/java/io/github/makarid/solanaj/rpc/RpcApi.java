...
import io.github.makarid.solanaj.rpc.types.*;
import io.github.makarid.solanaj.ws.listeners.NotificationEventListener;
import io.github.makarid.solanaj.rpc.types.config.BlockConfig;
import io.github.makarid.solanaj.rpc.types.ConfirmedSignFAddr2;
import io.github.makarid.solanaj.rpc.types.DataSize;
import io.github.makarid.solanaj.rpc.types.Filter;
import io.github.makarid.solanaj.rpc.types.Memcmp;
import io.github.makarid.solanaj.rpc.types.config.LargestAccountConfig;
import io.github.makarid.solanaj.rpc.types.config.LeaderScheduleConfig;
import io.github.makarid.solanaj.rpc.types.config.ProgramAccountConfig;
import io.github.makarid.solanaj.rpc.types.config.RpcEpochConfig;
import io.github.makarid.solanaj.rpc.types.config.RpcSendTransactionConfig;
import io.github.makarid.solanaj.rpc.types.config.SignatureStatusConfig;
import io.github.makarid.solanaj.rpc.types.config.SimulateTransactionConfig;
import io.github.makarid.solanaj.rpc.types.config.Commitment;
import io.github.makarid.solanaj.rpc.types.config.VoteAccountConfig;
import io.github.makarid.solanaj.ws.SubscriptionWebSocketClient;
...
public class RpcApi {
  ...
  public String getRecentBlockhash(Commitment commitment) throws RpcException {
    ...
    return client
        .call("getRecentBlockhash", params, RecentBlockhash.class)
        .getValue()
        .getBlockhash();
  }

  public String sendTransaction(Transaction transaction, Account signer, String recentBlockHash)
      throws RpcException {
  ...
  public String sendTransaction(
      Transaction transaction, List<Account> signers, String recentBlockHash) throws RpcException {
  ...
  public void sendAndConfirmTransaction(
      Transaction transaction, List<Account> signers, NotificationEventListener listener)
      throws RpcException {
    String signature = sendTransaction(transaction, signers, null);

    SubscriptionWebSocketClient subClient =
        SubscriptionWebSocketClient.getInstance(client.getEndpoint());
  ...
  public List<SignatureInformation> getConfirmedSignaturesForAddress2(PublicKey account, int limit)
    ...
    List<AbstractMap> rawResult =
        client.call("getConfirmedSignaturesForAddress2", params, List.class);
  ...
  public List<ProgramAccount> getProgramAccounts(PublicKey account, long offset, String bytes)
      throws RpcException {
  ...
  public List<ProgramAccount> getProgramAccounts(PublicKey account) throws RpcException {
    return getProgramAccounts(
        account, new ProgramAccountConfig(RpcSendTransactionConfig.Encoding.base64));
  }

  @SuppressWarnings({"unchecked", "rawtypes"})
  public List<ProgramAccount> getProgramAccounts(
      PublicKey account, ProgramAccountConfig programAccountConfig) throws RpcException {
    List<Object> params = new ArrayList<Object>();
  ...
  @SuppressWarnings({"unchecked", "rawtypes"})
  public List<ProgramAccount> getProgramAccounts(
      PublicKey account, List<Memcmp> memcmpList, int dataSize) throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  @SuppressWarnings({"unchecked", "rawtypes"})
  public List<ProgramAccount> getProgramAccounts(PublicKey account, List<Memcmp> memcmpList)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public AccountInfo getAccountInfo(PublicKey account, Map<String, Object> additionalParams)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public long getMinimumBalanceForRentExemption(long dataLength, Commitment commitment)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public BlockProduction getBlockProduction(Map<String, Object> optionalParams)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public String requestAirdrop(PublicKey address, long lamports, Commitment commitment)
      throws RpcException {
    List<Object> params = new ArrayList<Object>();
  ...
  public FeeCalculatorInfo getFeeCalculatorForBlockhash(String blockhash, Commitment commitment)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public SimulatedTransaction simulateTransaction(String transaction, List<PublicKey> addresses)
      throws RpcException {
    SimulateTransactionConfig simulateTransactionConfig =
        new SimulateTransactionConfig(RpcSendTransactionConfig.Encoding.base64);
    ...
    SimulatedTransaction simulatedTransaction =
        client.call("simulateTransaction", params, SimulatedTransaction.class);
  ...
  /**
   * Returns identity and transaction information about a confirmed block in the ledger DEPRECATED:
  ...
  public PublicKey getTokenAccountsByOwner(PublicKey owner, PublicKey tokenMint)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public List<InflationReward> getInflationReward(
      List<PublicKey> addresses, Long epoch, Commitment commitment) throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  /** Returns a list of confirmed blocks between two slots DEPRECATED: use getBlocks instead */
  @Deprecated
  ...
  public TokenResultObjects.TokenAmountInfo getTokenAccountBalance(PublicKey tokenAccount)
      throws RpcException {
    return getTokenAccountBalance(tokenAccount, null);
  }

  public TokenResultObjects.TokenAmountInfo getTokenAccountBalance(
      PublicKey tokenAccount, Commitment commitment) throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public TokenResultObjects.TokenAmountInfo getTokenSupply(PublicKey tokenMint)
      throws RpcException {
    return getTokenSupply(tokenMint, null);
  }

  public TokenResultObjects.TokenAmountInfo getTokenSupply(
      PublicKey tokenMint, Commitment commitment) throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public List<TokenResultObjects.TokenAccount> getTokenLargestAccounts(PublicKey tokenMint)
      throws RpcException {
    return getTokenLargestAccounts(tokenMint, null);
  }

  public List<TokenResultObjects.TokenAccount> getTokenLargestAccounts(
      PublicKey tokenMint, Commitment commitment) throws RpcException {
    List<Object> params = new ArrayList<>();
    params.add(tokenMint.toString());
    ...
    List<TokenResultObjects.TokenAccount> result = new ArrayList<>();
  ...
  public TokenAccountInfo getTokenAccountsByOwner(
      PublicKey accountOwner,
  ...
  public TokenAccountInfo getTokenAccountsByDelegate(
      PublicKey accountDelegate,
      Map<String, Object> requiredParams,
      Map<String, Object> optionalParams)
      throws RpcException {
    return getTokenAccount(
        accountDelegate, requiredParams, optionalParams, "getTokenAccountsByDelegate");
  }

  private TokenAccountInfo getTokenAccount(
      PublicKey account,
      Map<String, Object> requiredParams,
      Map<String, Object> optionalParams,
      String method)
  ...
  public VoteAccounts getVoteAccounts(PublicKey votePubkey, Commitment commitment)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public StakeActivation getStakeActivation(PublicKey publicKey, Long epoch, Commitment commitment)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public SignatureStatuses getSignatureStatuses(
      List<String> signatures, boolean searchTransactionHistory) throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public List<LargeAccount> getLargestAccounts(String filter, Commitment commitment)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public List<LeaderSchedule> getLeaderSchedule(Long epoch, String identity, Commitment commitment)
      throws RpcException {
    List<Object> params = new ArrayList<>();
  ...
  public List<AccountInfo.Value> getMultipleAccounts(List<PublicKey> publicKeys)
      throws RpcException {
    return getMultipleAccounts(publicKeys, new HashMap<>());
  }

  public List<AccountInfo.Value> getMultipleAccounts(
      List<PublicKey> publicKeys, Map<String, Object> additionalParams) throws RpcException {
    List<Object> params = new ArrayList<>();
