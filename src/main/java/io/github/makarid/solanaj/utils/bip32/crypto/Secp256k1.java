package io.github.makarid.solanaj.utils.bip32.crypto;
...
public class Secp256k1 {
  ...
  /**
   * serP(P): serializes the coordinate pair P = (x,y) as a byte sequence using SEC1's compressed
   * form: (0x02 or 0x03) || ser256(x), where the header byte depends on the parity of the omitted y
   * coordinate.
   *
   * @param p point
